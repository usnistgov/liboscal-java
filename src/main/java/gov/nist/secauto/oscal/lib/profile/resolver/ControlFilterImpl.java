...
class ControlFilterImpl implements IControlFilter {
  @NotNull
  ...
  public ControlFilterImpl(@NotNull IControlSelectionFilter includes, @NotNull IControlSelectionFilter excludes) {
